...
{ unfold c1; rewrite F.fromZ_correct; simpl; apply f_equal; lra. }
unfold F.toR, c1; rewrite F.fromZ_correct; simpl; rewrite Rabs_R1; lra.
Qed.
...
assert (H: forall prec xi x,
  ...
  rewrite F.add_correct, c1_8_correct, F.fromZ_correct.
  simpl.
  intro H.
  assert (H' : (u <= 1 + / 256)%R).
